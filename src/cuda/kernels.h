...
/* Endocrine constants (Phase 9 — no longer stubs) */
#define ATP_TARGET 1000.0f
#define NA_BASAL 0.1f
#define THETA_NOVEL 0.5f
...
#define ALPHA_DA 0.001f
#define ALPHA_NA 0.5f
#define ALPHA_SER 0.0001f
#define ALPHA_ACH 0.1f
